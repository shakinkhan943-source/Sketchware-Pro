...
public class ProjectLibraryBean implements Parcelable {
    ...
    public static final int PROJECT_LIB_TYPE_COMPOSE = 8;
    ...
    public static int getLibraryIcon(int i) {
        return switch (i) {
            ...
            case 8 -> R.drawable.ic_mtrl_compose;
    ...
    public static int getLibraryResDesc(int i) {
        return switch (i) {
            ...
            case 8 -> R.string.design_library_description_compose;
    ...
    public static int getLibraryResName(int i) {
        return switch (i) {
            ...
            case 8 -> R.string.design_library_title_compose;
            default -> R.string.common_word_empty;
        };
    }
