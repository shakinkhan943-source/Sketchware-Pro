...
import pro.sketchware.activities.editor.manage.library.ManageLocalLibraryActivity;
...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        managersCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_article, "Jetpack library store", "Import a Compose or Jetpack dependency ZIP once; its folders become shared libraries every project can switch on.", new ActivityLauncher(new Intent(getApplicationContext(), ComposeLibraryActivity.class))), true);
