...
public class ComposeLibraryActivity extends BaseAppCompatActivity {
    ...
    private void initialize() {
        ...
        if (!ComposeBuiltInLibraries.isBundleAvailable()) {
            // The built-in Compose bundle is generated by CI and packaged into the APK.
            // A build made before that workflow has produced compose-libs.zip won't have
            // it yet, so disable the feature instead of crashing when the manifest is read.
            ...
            android.widget.Toast.makeText(this,
                    "Built-in Jetpack Compose libraries aren't bundled in this build yet.",
